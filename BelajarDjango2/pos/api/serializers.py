...
#from pos_app.models import (User, StatusModel, Profile, TableResto, Category, MenuResto, OrderMenu, OrderMenuDetail,)
from pos_app.models import (User, StatusModel, TableResto, Category, MenuResto,)
